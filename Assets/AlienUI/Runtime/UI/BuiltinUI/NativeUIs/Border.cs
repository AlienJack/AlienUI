...
namespace AlienUI.UIElements
{
    public class Border : UIElement
    {
        ...
        public static readonly DependencyProperty BorderColorProperty =
            DependencyProperty.Register("BorderColor", typeof(Color), typeof(Border), Color.black, OnBorderColorChanged);
        ...
        public static readonly DependencyProperty FrontColorProperty =
            DependencyProperty.Register("FrontColor", typeof(Color), typeof(Border), Color.white, OnFrontColorChanged);
        ...
        public static readonly DependencyProperty BorderWidthProperty =
            DependencyProperty.Register("BorderWidth", typeof(float), typeof(Border), 2f, OnBorderWidthChanged);
        ...
        public static readonly DependencyProperty DivisionProperty =
            DependencyProperty.Register("Division", typeof(int), typeof(Border), 20, OnDivisionChanged);
        ...
        public static readonly DependencyProperty BorderRadiusProperty =
            DependencyProperty.Register("BorderRadius", typeof(float), typeof(Border), 5f, OnRadiusChanged);
        ...
        public static readonly DependencyProperty AAProperty =
            DependencyProperty.Register("AA", typeof(float), typeof(Border), 0.5f, OnAntiAliasChanged);
